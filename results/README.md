...
- `milestone5_baseline_results.json`: Groq zero-shot baseline metrics and side-by-side interpretation.
- `milestone6_sample_classifications.json`: final sample predictions with confidence scores for the README/demo.
- `evaluation_results.json`: final Milestone 5 comparison artifact for the README.
